hl.on("hyprland.start", function()
    ...
    hl.exec_cmd("sh -c 'if command -v swww >/dev/null 2>&1; then pkill hyprpaper; pkill swww-daemon; swww-daemon --format xrgb & else pkill swww-daemon; pkill hyprpaper; sleep 1; hyprpaper; fi'")
